...
def chicken_dynamics():
    payoff_matrix = utils.game_payoffs_array(chicken_game)
    ...
    ax1.set_xlabel("player 1, probability of choosing swerve", fontsize=8.5)
    ax1.set_ylabel("player 2, probability of choosing swerve", fontsize=8.5)
    ax2.streamplot(lenient_dynamics, density=0.6)
    ax2.set_title("Lenient boltzmann Q-learning dynamics", fontsize=9)
    ax2.set_xlabel("player 1, probability of choosing swerve", fontsize=8.5)
    ax2.set_ylabel("player 2, probability of choosing swerve", fontsize=8.5)
    plt.tight_layout()
    plt.show()
