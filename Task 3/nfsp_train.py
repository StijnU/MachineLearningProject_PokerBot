...
def train_nfsp(game, num_players=2, num_train_episodes=100000, eval_every=10000, hidden_layers_sizes=[128], replay_buffer_capacity=int(2e5), reservoir_buffer_capacity=int(2e6), anticipatory_param=0.1):
